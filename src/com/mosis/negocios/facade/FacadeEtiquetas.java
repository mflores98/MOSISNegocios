...
//    }
     ...
     * @param usuario
     */
    public void addEtiqueta(Etiquetas etiqueta, Usuarios usuario) {
...
//        Etiquetas e = new Etiquetas();
//        e.setValorTag("valorEtiquetaTest5");
//        e.setNombre("NombreEtiquetaTest5");
//        e.setLatitud("LatEtiquetaTest5");
//        e.setLongitud("lanEtiquetaTest5");
//        e.setFechaCreacion(new Date());
//        e.setFechaModificacion(new Date());
//        FacadeUsuarios fu = new FacadeUsuarios();
//        Usuarios us = fu.usuariosId(1);
//        e.setFkIdUsuarioCreo(us);
//        e.setFkIdUsuarioModifico(us);
...
//        FacadeEtiquetas eti = new FacadeEtiquetas();
//        Etiquetas e = new Etiquetas();
//        e.setIdEtiqueta(7);///editar etiqueta con id 7
//        e.setValorTag("valorEtiquetaTestUpdate");
//        e.setNombre("NombreEtiquetaTestUpdate");
//        e.setLatitud("LatEtiquetaTestUpdate");
//        e.setLongitud("lanEtiquetaTestUpdate");
//        e.setFechaCreacion(new Date());
//        e.setFechaModificacion(new Date());
//        FacadeUsuarios fu = new FacadeUsuarios();
